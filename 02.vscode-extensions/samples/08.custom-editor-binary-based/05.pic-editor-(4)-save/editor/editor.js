(() => {
    ...
    class PictureEditor {
        ...
        async getImageData() {
            ...
            outContext.drawImage(this.initialCanvas, 0, 0);
    ...
    window.addEventListener('message', async (e) => {
        ...
        console.log('=====[webview::message]=====data', e.data)
        switch (type) {
            case 'init':
            ...
            // ④
            case 'file-data':
                const data = await editor.getImageData();
                vscode.postMessage({ type: 'file-data', body: { data, ...body } })
                break;
            default:
                break;
        }
